...
/// 
Shader "Universal Render Pipeline/VolumetricLine/LineStrip-TextureAlphaBlended" {
	Properties {
	...
	SubShader {
		...
		Pass {
			Name "VolumetricLine-LineStrip-TextureAlphaBlended"
            HLSLPROGRAM
